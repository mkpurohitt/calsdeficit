    ...
    <div style={{ maxWidth: 560, display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <div
        ...
        style={{
          ...
          background: scan.verified ? "color-mix(in srgb, var(--accent) 12%, transparent)" : "rgba(255, 184, 0, 0.12)",
      ...
      {onAdd && (
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: "none",
            background: addState === "saved" ? "color-mix(in srgb, var(--accent) 12%, transparent)" : "var(--lime-400)",
            color: addState === "saved" ? "var(--lime-400)" : "var(--on-accent)",
            fontSize: 14,
            fontWeight: 700,
